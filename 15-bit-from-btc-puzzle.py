#!/usr/bin/env python3
"""
BITCOIN PUZZLE #15 - ULTIMATE PURE SHOR'S STYLE QUANTUM ECDLP SOLVER
Full range: 0x4000 to 0x7fff
...
def main():
    print("\n" + "="*140)
    print("BITCOIN PUZZLE #15 - ULTIMATE PURE SHOR'S STYLE QUANTUM ECDLP SOLVER")
    ...
    effective_bits = min(15, 40)   # SAFE LIMIT for current hardware
